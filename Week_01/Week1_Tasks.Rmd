...
# Task 5: Load Dataset
# Write your code here
student_scores <- read.csv(file = "examples/student_scores.csv")
student_scores[c(1:5),c(1,2)]
```
...
excel_students <- student_scores |> filter(Score > 80)
excel_students
```
...
# Task 8: Sorting Data
# Write your code here
sorted_score <- student_scores |> arrange(desc(Score))
sorted_score[c(0:3),]
```
